## PONGGEUL(퐁글퐁글) 🫧📚
> 본 서비스는 사용자의 독서 취향을 기반으로 자유로운 감상평을 작성하고 공유하는 시스템입니다. </br> **네이버 검색 API**로 검색어로 책을 직접 검색하고, 감상평을 노트에 작성해 그때 퐁글퐁글했던 감상을 기록합니다. </br> 더불어 친구들에게 비눗방울 날리듯 책과 노트를 **카카오톡 메시지**로 공유해 지속적인 독서활동을 지원합니다.
